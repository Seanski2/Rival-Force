execute if score $pointScoreA pointScoreA > $pointScoreB pointScoreB run title @a title [{"bold":true,"color":"#FF0000","text":"TEAM A "},{"bold":false,"color":"#FFFFFF","text":"wins!"}]
execute if score $pointScoreA pointScoreA <= $pointScoreB pointScoreB run title @a title [{"bold":true,"color":"#0000FF","text":"TEAM B "},{"bold":false,"color":"#FFFFFF","text":"wins!"}]
