# Spawn & Reposition
execute at @a[scores={charID=1, itemActivation=1..}] run summon area_effect_cloud ^ ^1 ^2 {custom_particle:{type:"crit"},Radius:0f,Duration:100,Tags:["char_dummy_standard"]}
