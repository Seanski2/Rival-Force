...
# Damage
execute at @e[type=minecraft:area_effect_cloud,tag=char_dummy_standard] as @n[distance=..1.6,type=!area_effect_cloud] run execute unless score @n[type=minecraft:area_effect_cloud,tag=char_dummy_standard] Affiliation = @s Affiliation run function rivalforce:characters/dummy/move0/standard_fire_effect
