...
# Frame Step
execute at @e[type=minecraft:area_effect_cloud,tag=char_dummy_combo_1,scores={attack_anim_frame=1..}] as @s run scoreboard players add @s attack_anim_frame 1
...
# Block Detection
execute as @n[type=minecraft:area_effect_cloud,tag=char_dummy_combo_1] at @s unless block ~ ~ ~ air run kill @n[type=minecraft:area_effect_cloud,tag=char_dummy_combo_1]