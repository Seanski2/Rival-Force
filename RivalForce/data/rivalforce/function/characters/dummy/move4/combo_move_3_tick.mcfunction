...
# Damage
execute at @e[type=minecraft:area_effect_cloud,tag=char_dummy_combo_3] positioned ^ ^ ^-1 as @n[distance=..2.5,type=!area_effect_cloud] run execute unless score @n[type=minecraft:area_effect_cloud,tag=char_dummy_combo_3] Affiliation = @s Affiliation run damage @s[tag=!invincible] 10 minecraft:player_attack
...
# Block Collision Aoe
execute at @e[type=minecraft:area_effect_cloud,tag=char_dummy_combo_3] positioned ^ ^ ^-1 as @n[distance=..4,type=!area_effect_cloud] run execute unless score @n[type=minecraft:area_effect_cloud,tag=char_dummy_combo_3] Affiliation = @s Affiliation run damage @s[tag=!invincible] 3 minecraft:player_attack