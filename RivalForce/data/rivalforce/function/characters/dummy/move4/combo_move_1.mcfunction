...
execute at @a[scores={charID=0, itemActivation=1..}] as @e[type=minecraft:area_effect_cloud, tag=char_dummy_combo_1, limit=1, sort=nearest] run scoreboard players set @s attack_anim_frame 1
