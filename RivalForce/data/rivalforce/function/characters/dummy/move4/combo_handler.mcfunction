...
execute if entity @a[scores={itemActivation=1..,moveSlotComboCounter4=2,charID=0,moveSlotExtra4=..22},nbt={SelectedItem:{components:{"minecraft:custom_data":{moveSlot:4}}}}] run function rivalforce:characters/dummy/move4/combo_move_2
execute if entity @a[scores={itemActivation=1..,moveSlotComboCounter4=3,charID=0,moveSlotExtra4=..26},nbt={SelectedItem:{components:{"minecraft:custom_data":{moveSlot:4}}}}] run function rivalforce:characters/dummy/move4/combo_move_3
