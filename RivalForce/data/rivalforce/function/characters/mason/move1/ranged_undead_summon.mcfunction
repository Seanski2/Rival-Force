...
# Set Affiliation
execute at @a[scores={charID=1, itemActivation=1..}] if entity @p[distance=..1,sort=nearest,limit=1,team=teamA] run scoreboard players operation @e[type=minecraft:pillager, limit=3, sort=nearest, team=teamA] Affiliation = @p Affiliation
execute at @a[scores={charID=1, itemActivation=1..}] if entity @p[distance=..1,sort=nearest,limit=1,team=teamB] run scoreboard players operation @e[type=minecraft:pillager, limit=3, sort=nearest, team=teamB] Affiliation = @p Affiliation
