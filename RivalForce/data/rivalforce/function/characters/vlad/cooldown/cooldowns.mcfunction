# Slot 0
execute at @p[scores={moveSlotCooldown0=..0,charID=1}] run function rivalforce:characters/vlad/cooldown/move0_cooldown

# Slot 1
execute at @p[scores={moveSlotCooldown1=..0,charID=1}] run function rivalforce:characters/vlad/cooldown/move1_cooldown

# Slot 2
execute at @p[scores={moveSlotCooldown2=..0,charID=1}] run function rivalforce:characters/vlad/cooldown/move2_cooldown
