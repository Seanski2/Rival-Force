...
# Inbetween Cooldown
scoreboard players set @p[scores={charID=0, itemActivation=1.., moveSlotComboCounter4=..1}] moveSlotExtra4 40

# Advance Combo
scoreboard players set @p[scores={charID=0, itemActivation=1.., moveSlotComboCounter4=..1}] moveSlotComboCounter4 2