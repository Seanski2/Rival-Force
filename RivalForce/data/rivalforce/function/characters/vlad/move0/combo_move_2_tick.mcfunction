...
# Particles
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^ ^0.5 ^0 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^ ^0.5 ^-0.5 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^ ^0.5 ^-1 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^ ^0.5 ^-1.5 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^ ^0.5 ^-2 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^0.5 ^0.75 ^0 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^0.5 ^0.75 ^-0.5 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^0.5 ^0.75 ^-1 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^0.5 ^0.75 ^-1.5 0.1 0.1 0.1 0 100 force
execute at @e[type=minecraft:area_effect_cloud,tag=char_vlad_combo_2] run particle dust{color:[1.000,0.000,0.267],scale:1} ^0.5 ^0.75 ^-2 0.1 0.1 0.1 0 100 force
