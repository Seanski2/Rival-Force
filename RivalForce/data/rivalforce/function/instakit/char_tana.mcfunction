# Initial Setup
scoreboard players set @p charID 4
function rivalforce:instakit/instakit_setup

# Helmet/Stats

item replace entity @p armor.head with player_head[attribute_modifiers=[{id:"max_health",type:"max_health",amount:10,operation:"add_value",slot:"head"},{id:"movement_speed",type:"movement_speed",amount:0.5,operation:"add_multiplied_base",slot:"head"},{id:"jump_strength",type:"jump_strength",amount:0.35,operation:"add_value",slot:"head"},{id:"gravity",type:"gravity",amount:0.45,operation:"add_multiplied_base",slot:"head"},{id:"knockback_resistance",type:"knockback_resistance",amount:0,operation:"add_value",slot:"head"},{id:"scale",type:"scale",amount:-0.1527777778,operation:"add_value",slot:"head"},{id:"armor",type:"armor",amount:10,operation:"add_value",slot:"head"},{id:"step_height",type:"step_height",amount:0.5,operation:"add_value",slot:"head"},{id:"safe_fall_distance",type:"safe_fall_distance",amount:1000,operation:"add_value",slot:"head"}],unbreakable={},custom_name={"bold":true,"color":"#FF4400","text":"Tana's Head"}] 1

# Other Armor

item replace entity @p armor.chest with leather_chestplate[dyed_color=16121921,attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_value",slot:"chest"}],unbreakable={},trim={material:"minecraft:netherite",pattern:"minecraft:wild"}] 1
item replace entity @p armor.legs with leather_leggings[dyed_color=4194320,attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_value",slot:"legs"}],unbreakable={},trim={material:"minecraft:amethyst",pattern:"minecraft:vex"}] 1
item replace entity @p armor.feet with leather_boots[dyed_color=16704490,attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_value",slot:"feet"}],unbreakable={}] 1
